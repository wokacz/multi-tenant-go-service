...
(
    ...
    "role_id"         uuid NULL,
    "permission_key"  character varying NULL,
    "ip"              inet              NOT NULL,
...
(
    ...
    "user_id"     uuid              NOT NULL,
    PRIMARY KEY ("id"),
    CONSTRAINT "email_changes_users_email_changes" FOREIGN KEY ("user_id") REFERENCES "users" ("id") ON UPDATE NO ACTION ON DELETE CASCADE
);
...
(
    ...
    PRIMARY KEY ("id"),
    CONSTRAINT "invitations_organizations_invitations" FOREIGN KEY ("organization_id") REFERENCES "organizations" ("id") ON UPDATE NO ACTION ON DELETE CASCADE
);
...
(
    ...
    "organization_id" uuid              NOT NULL,
    PRIMARY KEY ("id"),
    CONSTRAINT "roles_organizations_roles" FOREIGN KEY ("organization_id") REFERENCES "organizations" ("id") ON UPDATE NO ACTION ON DELETE CASCADE
);
...
(
    ...
    PRIMARY KEY ("id"),
    CONSTRAINT "invitation_roles_invitations_roles" FOREIGN KEY ("invitation_id") REFERENCES "invitations" ("id") ON UPDATE NO ACTION ON DELETE CASCADE,
    CONSTRAINT "invitation_roles_roles_invitation_roles" FOREIGN KEY ("role_id") REFERENCES "roles" ("id") ON UPDATE NO ACTION ON DELETE CASCADE
);
...
(
    ...
    "user_id"    uuid              NOT NULL,
    PRIMARY KEY ("id"),
    CONSTRAINT "login_events_users_login_events" FOREIGN KEY ("user_id") REFERENCES "users" ("id") ON UPDATE NO ACTION ON DELETE CASCADE,
...
(
    ...
    "user_id"         uuid              NOT NULL,
    PRIMARY KEY ("id"),
    CONSTRAINT "memberships_organizations_memberships" FOREIGN KEY ("organization_id") REFERENCES "organizations" ("id") ON UPDATE NO ACTION ON DELETE CASCADE,
    CONSTRAINT "memberships_users_memberships" FOREIGN KEY ("user_id") REFERENCES "users" ("id") ON UPDATE NO ACTION ON DELETE CASCADE,
...
(
    ...
    "role_id"       uuid        NOT NULL,
    PRIMARY KEY ("id"),
    CONSTRAINT "membership_roles_memberships_roles" FOREIGN KEY ("membership_id") REFERENCES "memberships" ("id") ON UPDATE NO ACTION ON DELETE CASCADE,
    CONSTRAINT "membership_roles_roles_membership_roles" FOREIGN KEY ("role_id") REFERENCES "roles" ("id") ON UPDATE NO ACTION ON DELETE CASCADE
);
...
(
    ...
    "user_id"     uuid              NOT NULL,
    PRIMARY KEY ("id"),
    CONSTRAINT "password_resets_users_password_resets" FOREIGN KEY ("user_id") REFERENCES "users" ("id") ON UPDATE NO ACTION ON DELETE CASCADE
);
...
(
    ...
    "user_id"     uuid              NOT NULL,
    PRIMARY KEY ("id"),
    CONSTRAINT "two_factor_challenges_devices_challenges" FOREIGN KEY ("device_id") REFERENCES "devices" ("id") ON UPDATE NO ACTION ON DELETE CASCADE,
    CONSTRAINT "two_factor_challenges_users_challenges" FOREIGN KEY ("user_id") REFERENCES "users" ("id") ON UPDATE NO ACTION ON DELETE CASCADE
);
...
(
    ...
    "user_id"    uuid              NOT NULL,
    PRIMARY KEY ("id"),
    CONSTRAINT "user_system_roles_users_system_roles" FOREIGN KEY ("user_id") REFERENCES "users" ("id") ON UPDATE NO ACTION ON DELETE CASCADE
);
