...
func (_c *RoleCreate) AddMembershipRoleIDs(ids ...uuid.UUID) *RoleCreate {
	_c.mutation.AddMembershipRoleIDs(ids...)
	return _c
}

// AddMembershipRoles adds the "membership_roles" edges to the MembershipRole entity.
func (_c *RoleCreate) AddMembershipRoles(v ...*MembershipRole) *RoleCreate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddMembershipRoleIDs(ids...)
}

// AddInvitationRoleIDs adds the "invitation_roles" edge to the InvitationRole entity by IDs.
func (_c *RoleCreate) AddInvitationRoleIDs(ids ...uuid.UUID) *RoleCreate {
	_c.mutation.AddInvitationRoleIDs(ids...)
	return _c
}

// AddInvitationRoles adds the "invitation_roles" edges to the InvitationRole entity.
func (_c *RoleCreate) AddInvitationRoles(v ...*InvitationRole) *RoleCreate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddInvitationRoleIDs(ids...)
}
...
func (_c *RoleCreate) createSpec() (*Role, *sqlgraph.CreateSpec) {
	...
	if nodes := _c.mutation.MembershipRolesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := _c.mutation.InvitationRolesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
